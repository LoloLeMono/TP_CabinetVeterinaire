...
public class Cabinet extends UnicastRemoteObject implements ICabinet{
	...
	public void add(String n, String m, String e, String r) throws RemoteException {
		...
		switch (liste.size()) {
			...
			case 100:
				instance.notifyAllClients("Il y a actuellement 100 animaux");
				break;

			case 500:
				instance.notifyAllClients("Il y a actuellement 500 animaux");
				break;

			case 1000:
				instance.notifyAllClients("Il y a actuellement 1000 animaux");
				break;
		}
	}
}
